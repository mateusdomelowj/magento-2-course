    ...
    var rules = {
        ...
        "validate-customer-password": [
            function (v, elm) {
                ...
                var passwordMinCharacterSets = $(elm).data(
        ...
        "validate-date-range": [
            function (v, elm) {
                ...
                var dependentElements = $(elm.form).find(
        ...
        "not-negative-amount": [
            function (v) {
                if (v.length) return /^\s*\d+([,.]\d+)*\s*%?\s*$/.test(v);
                else return true;
            },
